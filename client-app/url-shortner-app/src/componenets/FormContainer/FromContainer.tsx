    ...
    <div className='container mx-auto p-2'>
      <div className='bg-banner my-8 rounded-xl bg-cover bg-center'>
        <div className='w-full h-full rounded-xl p-20 backdrop-brightness-50'>
          ...
          <p className='text-white text-center pb-4 text-xl font-extralight'>Paste your untidy link to shorten it</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className='flex'>
              <div className='relative w-full'>
                <div className='absolute inset-y-0 start-0 flex items-center pointer-events-none text-slate-800'>
                  Urlshortner.link/
                </div>
                <input
                  type='text'
                  ...
                  required
                  className='block w-full p-4 ps-32 text-sm text-gray-900 border border-gray-300 bg-white focus:ring-blue-500 focus:border-blue-500'
                  value={fullUrl}
